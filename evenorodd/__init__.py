...
def compiles():
    """evenorodd.c compiles"""
    check50.c.compile("evenorodd.c", lcs50=True)


@check50.check(compiles)
def test_2():
    """test_2"""
    test_input_output("./evenorodd", "test_2_input.txt", "test_2_output.txt")


@check50.check(compiles)
def test_1():
    """test_1"""
    test_input_output("./evenorodd", "test_1_input.txt", "test_1_output.txt")


@check50.check(compiles)
def test_3():
    """test_3"""
    test_input_output("./evenorodd", "test_3_input.txt", "test_3_output.txt")


@check50.check(compiles)
def test_4():
    """test_4"""
    test_input_output("./evenorodd", "test_4_input.txt", "test_4_output.txt")
